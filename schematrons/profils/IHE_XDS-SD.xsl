...
<xsl:template match="/">
      ...
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Rapport de conformité du document aux spécifications IHE (en-tête)"
                              schemaVersion="IHE_XDS-SD.sch">
         <xsl:attribute name="phase">xds-sd</xsl:attribute>
         ...
         <xsl:text/>
         <svrl:active-pattern>
            <xsl:attribute name="id">recordTarget_int</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M6"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">author_int</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M7"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">legalAuthenticator_int</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
   ...
   <!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Rapport de conformité du document aux spécifications IHE (en-tête)</svrl:text>

   <!--PATTERN recordTarget_int-->
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:patient/cda:name/cda:family"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
   ...
   <!--PATTERN author_int-->
	...
	<!--RULE -->
<xsl:template match="cda:ClinicalDocument/cda:author" priority="1000" mode="M7">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="cda:ClinicalDocument/cda:author"/>
      <xsl:variable name="count_name_patient" select="count(cda:time)"/>
      <xsl:variable name="count_name_guardianPerson"
                    select="count(cda:patient/cda:guardian/cda:guardianPerson/cda:name)"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:assignedAuthor/cda:id[@root] and cda:assignedAuthor/cda:id[@extension]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(cda:assignedAuthor/cda:representedOrganization/cda:id[@root] and cda:assignedAuthor/cda:representedOrganization/cda:id[@extension]) or not(cda:assignedAuthor/cda:representedOrganization)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
   ...
   <!--PATTERN legalAuthenticator_int-->


	<!--RULE -->
<xsl:template match="cda:ClinicalDocument/cda:legalAuthenticator/cda:assignedEntity/cda:id"
                 priority="1000"
                 mode="M8">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="cda:ClinicalDocument/cda:legalAuthenticator/cda:assignedEntity/cda:id"/>
