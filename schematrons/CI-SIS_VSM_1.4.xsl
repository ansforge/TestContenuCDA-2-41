...
<xsl:template match="/">
      ...
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Vérification de conformité du document aux spécifications du modèle VSM_1.4"
                              schemaVersion="CI-SIS_VSM_1.4.sch">
         <xsl:attribute name="phase">CI-SIS_VSM_1.4</xsl:attribute>
   ...
   <!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de conformité du document aux spécifications du modèle VSM_1.4</svrl:text>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:code[@code='SYNTH' and @codeSystem='1.2.250.1.213.1.1.4.12']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
	  ...
	  <!--RULE -->
<xsl:template match="cda:ClinicalDocument/cda:component/cda:structuredBody" priority="1002"
                 mode="M6">
...
<xsl:template match="cda:ClinicalDocument" priority="1001" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="cda:ClinicalDocument"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="count(cda:participant[@typeCode='INF']/cda:functionCode[@code='PCP']) =1                                  and count(cda:participant[@typeCode='INF']/cda:functionCode[@displayName='Médecin Traitant']) =1                                                                                                                  and count(cda:participant[@typeCode='INF']/cda:functionCode[@codeSystem='2.16.840.1.113883.5.88']) =1"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
