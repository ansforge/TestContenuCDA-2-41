...
<!--  S_scoreNIHSS_ANS.sch
    
     Vérification de la conformité de la section FR-Scores-NIHSS (1.2.250.1.213.1.1.2.36) créée par l'ANS
...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="S_scoreNIHSS_ANS">
    
    <title>Vérification de la conformité de la section FR-Scores-NIHSS (1.2.250.1.213.1.1.2.36) créée par l'ANS</title>
