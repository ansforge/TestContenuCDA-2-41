...
<!-- S_scoreEvaluationClinique_ANS.sch
    
     Vérification de la conformité de la section FR-Scores-evaluation-clinique (1.2.250.1.213.1.1.2.41) créée par l'ANS    
...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="S_scoreEvaluationClinique_ANS">
    ...
    <title>Vérification de la conformité de la section FR-Scores-evaluation-clinique (1.2.250.1.213.1.1.2.41) créée par l'ANS</title>
    ...
    <rule context='*[cda:templateId/@root = "1.2.250.1.213.1.1.2.41"]'>
        ...
        <!-- Vérification des sous-sections autorisées -->
