...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_ConduiteATenir_2-CISIS" is-a="dansJeuDeValeurs">
    ...
    <param name="xpath_elt" value="cda:observation[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.1.20.3.1' and cda:code[@code='GEN-007']/cda:qualifier[cda:name/@code='MED-121']/cda:value[@code='MED-131' or @code='MED-132' or @code='MED-133']]/cda:value"/>
