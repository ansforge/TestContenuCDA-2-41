...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="JDV_ModeAdministration-CISIS" is-a="dansJeuDeValeurs">
    <param name="path_jdv" value="$JDV_ModeAdministration-CISIS"/>
