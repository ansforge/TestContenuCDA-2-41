...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_historyOfPastIllness_CSE-CS24">
    ...
    <rule context='*[cda:templateId/@root="1.3.6.1.4.1.19376.1.5.3.1.3.8"]'>         
        ...
        <!-- Hospitalisation(s) depuis le 9ème mois ORG-090 -->
        <assert          
            test="cda:entry/cda:act[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.4.5.2']/cda:entryRelationship/cda:observation[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.4.5']/cda:value/@code='ORG-090'"> 
            [E_historyOfPastIllness_CSE-SC24] Erreur de conformité :
            L'entrée FR-Probleme "Hospitalisation(s) depuis le 9ème mois" est obligatoire.
        </assert>
        <assert test="cda:entry/cda:act[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.4.5.2']/cda:entryRelationship/cda:observation[cda:value/@code='ORG-090']/cda:entryRelationship/@typeCode='CAUS'"> 
            [E_historyOfPastIllness_CSE-SC24] Erreur de conformité : 
            Le motif d'hospitalisation doit être indiqué dans un élément entryRelationship d'attribut typeCode='CAUS'
        </assert>
        <assert test="cda:entry/cda:act[cda:templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.4.5.2']/cda:entryRelationship/cda:observation[cda:value/@code='ORG-090']/cda:entryRelationship/@typeCode='SUBJ'"> 
            [E_historyOfPastIllness_CSE-SC24] Erreur de conformité : 
