...
<!--  E_SondeStimOrg_F-PRC.sch
    ...
    Historique :
    10/08/2011 : Création pour les sondes stimulateurs
...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" id="E_SondeStimOrg_F-PRC">
    ...
    <rule context='*[(/cda:ClinicalDocument/cda:templateId[@root="1.2.250.1.213.1.1.1.2.1.4"]) 
        ...
        <assert test='(cda:component/cda:observation[cda:templateId/@root="1.2.250.1.213.1.1.3.1"]/cda:code/@code="L0055") and 
            ...
            [E_SondeStimOrg_F-PRC] Erreur de Conformité CI-SIS: La date d'implantation est un élément obligtoire. </assert>
        <!-- Dispositif implanté -->
        <assert test='cda:component/cda:observation[cda:templateId/@root="1.2.250.1.213.1.1.3.1"]
            /cda:code/@code="L0056"'> 
            [E_SondeStimOrg_F-PRC]  Erreur de Conformité CI-SIS: 'Dispositif implanté' est un élément obligtoire. </assert>
        <!-- Localisation de l'implant -->
        <assert test='cda:component/cda:observation[cda:templateId/@root="1.2.250.1.213.1.1.3.1"]
            /cda:code/@code="L0054"'> 
            [E_SondeStimOrg_F-PRC]  Erreur de Conformité CI-SIS: 'Localisation de l'implant'est un élément obligtoire. </assert>
        <!-- Marque de l'implant -->
        <assert test='cda:component/cda:observation[cda:templateId/@root="1.2.250.1.213.1.1.3.1"]
            /cda:code/@code="L0050"'> 
            [E_SondeStimOrg_F-PRC] Erreur de Conformité CI-SIS: 'Marque de l'implant'est un élément obligtoire. </assert>
        <!-- Modèle de l'implant -->
        <assert test='cda:component/cda:observation[cda:templateId/@root="1.2.250.1.213.1.1.3.1"]
            /cda:code/@code="L0051"'> 
            [E_SondeStimOrg_F-PRC]  Erreur de Conformité CI-SIS: 'Modèle de l'implant' est un élément obligtoire. </assert>
        <!-- Numéro de série -->
        <assert test='cda:component/cda:observation[cda:templateId/@root="1.2.250.1.213.1.1.3.1"]
            /cda:code/@code="L0059"'> 
            [E_SondeStimOrg_F-PRC] Erreur de Conformité CI-SIS: 'Numéro de série' est un élément obligtoire. </assert>
        <!-- Polarité -->
        <assert test='cda:component/cda:observation[cda:templateId/@root="1.2.250.1.213.1.1.3.1"]
            /cda:code/@code="L0053"'> 
            [E_SondeStimOrg_F-PRC] Erreur de Conformité CI-SIS: 'Polarité' est un élément obligtoire. </assert>
        <!-- Connexions -->
        <assert test='cda:component/cda:observation[cda:templateId/@root="1.2.250.1.213.1.1.3.1"]
            /cda:code/@code="L0017"'> 
            [E_SondeStimOrg_F-PRC] Erreur de Conformité CI-SIS: 'Connexions' est un élément obligtoire. </assert>

        <!-- Adapteur -->
        <assert test='cda:component/cda:observation[cda:templateId/@root="1.2.250.1.213.1.1.3.1"]
            /cda:code/@code="L0018"'> 
            [E_SondeStimOrg_F-PRC]  Erreur de Conformité CI-SIS: 'Adapteur'est un élément obligtoire. </assert>
        <!-- Voie d'abord  -->
        <assert test='cda:component/cda:observation[cda:templateId/@root="1.2.250.1.213.1.1.3.1"]
            /cda:code/@code="L0019"'> 
            [E_SondeStimOrg_F-PRC] Erreur de Conformité CI-SIS: 'Voie d'abord' est un élément obligtoire. </assert>
