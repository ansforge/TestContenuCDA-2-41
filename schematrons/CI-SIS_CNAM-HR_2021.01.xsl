...
<xsl:template match="/">
      ...
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Vérification de conformité du document aux spécifications du modèle CNAM-HR_2021.01"
                              schemaVersion="CI-SIS_CNAM-HR_2021.01.sch">
         <xsl:attribute name="phase">CI-SIS_CNAM-HR_2021.01</xsl:attribute>
   ...
   <!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de conformité du document aux spécifications du modèle CNAM-HR_2021.01</svrl:text>
